                ...
                <Slide direction="bottom" in={message.isShow}>
                    ...
                    >
                        <Flex direction="column" align="start" justify="start" gap="4">
                            {message.type === MessageType.SUCCESS && <SuccessSVG /> ||
                                message.type === MessageType.ERROR && <ErrorSVG /> ||
                                message.type === MessageType.WARNING && <WarningSVG />}
                            <Flex direction="column" align="start" justify="start" gap="4">
...
const SuccessSVG = () => {
    return <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clip-path="url(#clip0_1385_18782)">
            <path d="M15.2493 19L17.7493 21.5L22.7493 16.5M27.3327 19C27.3327 23.6024 23.6017 27.3333 18.9993 27.3333C14.397 27.3333 10.666 23.6024 10.666 19C10.666 14.3976 14.397 10.6667 18.9993 10.6667C23.6017 10.6667 27.3327 14.3976 27.3327 19Z" stroke="#079455" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
...
const ErrorSVG = () => {
    return <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clip-path="url(#clip0_1385_18820)">
            <path d="M18.9993 15.6667V19M18.9993 22.3334H19.0077M27.3327 19C27.3327 23.6024 23.6017 27.3334 18.9993 27.3334C14.397 27.3334 10.666 23.6024 10.666 19C10.666 14.3976 14.397 10.6667 18.9993 10.6667C23.6017 10.6667 27.3327 14.3976 27.3327 19Z" stroke="#D92D20" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
...
const WarningSVG = () => {
    return <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clip-path="url(#clip0_1385_18807)">
            <path d="M18.9993 15.6667V19M18.9993 22.3333H19.0077M27.3327 19C27.3327 23.6024 23.6017 27.3333 18.9993 27.3333C14.397 27.3333 10.666 23.6024 10.666 19C10.666 14.3976 14.397 10.6667 18.9993 10.6667C23.6017 10.6667 27.3327 14.3976 27.3327 19Z" stroke="#DC6803" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
